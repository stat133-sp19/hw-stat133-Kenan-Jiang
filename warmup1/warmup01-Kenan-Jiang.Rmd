...
You can make it anytime you want.<br/>Other Variations: If you wish to make a glaze: Whisk together 3/4 cup powdered sugar with 1 to 2 tablespoons of the leftover coconut milk, adding a little at a time, until it is smooth but not too runny. Add a pinch of salt, if you wish.
...
<br/> d(**p**, **q**) = d(**q**, **p**) = $\sqrt{(q_1 - p_1)^2 + (q_2 - p_2)^2 + ... + (q_n - p_n)^2}$ = $\sqrt{\sum_{i=1}^{n}(q_i - p_i)^2}$.
...
<br/>$||\mathbf{p}||$ = $\sqrt{p_1^2 +  p_2^2 + ... + p_n^2}$ = $\sqrt{\mathbf{p}\cdot\mathbf{p}}$,
